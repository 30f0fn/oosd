...
class CarDominanceCountComparator implements Comparator<Car> {
    ...
    protected CarDominanceCountComparator(CarViewer viewer) {
        this.viewer = viewer;
    ...
    public int compare(Car car1, Car car2) {
        // negative iff car1 is better iff car1 has greater domcount
